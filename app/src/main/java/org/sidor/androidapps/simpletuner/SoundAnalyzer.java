...
public class SoundAnalyzer extends Observable implements AudioRecord.OnRecordPositionUpdateListener {
	...
	private static final double MaxPossibleFrequency = 2000.0;     // result considered rubbish
	private static final double loudnessThreshold = 30.0; // below is too quiet Default=30
	private static final double PercentOfWavelenghSamplesToBeIgnored = 0.3; //Default = 0.2
